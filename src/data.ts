...
export const GLOBAL_TEAMS_DIRECTORY: FootballTeamProfile[] = [
  ...
  { id: 'civ', name: 'Côte d\'Ivoire', code: 'CIV', logo: '🇨🇮', country: 'Africa', founded: 1960, stadium: 'Stade Alassane Ouattara', form: ['W', 'D', 'W', 'W', 'D'] },
