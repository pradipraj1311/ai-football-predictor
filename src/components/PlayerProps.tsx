...
export const PlayerProps: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    ...
    const propsData = [
        {
            player: "Lionel Messi", team: "ARG", type: "Anytime Goalscorer",
            line: "Over 0.5 Goals", odds: "2.10", probability: 68,
            analysis: "France's left defensive channel shows a 14% drop in pace recovery after 60 mins. Messi's inside cuts will highly likely exploit this space.",
            edge: "High Value", color: "emerald"
        },
        {
            player: "Kylian Mbappé", team: "FRA", type: "Shots on Target",
            line: "Over 1.5 SOT", odds: "1.65", probability: 82,
            analysis: "Argentina plays a high line when pressing. Mbappé's sprint speed in transitional phases guarantees at least 2 clear shooting opportunities.",
            edge: "Banker", color: "blue"
        },
        {
            player: "Jude Bellingham", team: "ENG", type: "Player Assists",
            line: "Over 0.5 Assists", odds: "3.40", probability: 35,
            analysis: "While highly active, Bellingham is dropping deeper into a double-pivot role to manage possession. Less likely to register a final-third assist today.",
            edge: "Risky", color: "red"
        }
    ];
